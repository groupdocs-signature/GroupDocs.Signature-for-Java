...
public class SignWithDigitalAdvancedPdfCertificate
{
    ...
    {
        System.out.print("\n--------------------------------------------------------------------------------------------------------------------");
        System.out.print("[Example Advanced Usage] # SignWithDigitalAdvancedPdfCertificate : Sign document with digital signature applying PDF certificate options\n");

        // The path to the documents directory.            
        String filePath = Constants.SAMPLE_PDF;
        String certificatePath = Constants.CertificatePfx;

        String outputFilePath = new File(Constants.OutputPath, "SignWithDigitalAdvancedPdf\\digitallyCertified.pdf").getPath();
