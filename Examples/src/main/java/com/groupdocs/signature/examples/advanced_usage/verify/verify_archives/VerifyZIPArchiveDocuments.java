...
public class VerifyZIPArchiveDocuments
{
    /**
     * <p>
     * Verify documents at the ZIP archive documents with various options
     * </p>
     */
    public static void run() throws Exception
    {
        System.out.print("\n--------------------------------------------------------------------------------------------------------------------");
        System.out.print("[Example Advanced Usage] # VerifyZIPArchiveDocuments : Verify signatures at document packed to ZIP archive\n");
