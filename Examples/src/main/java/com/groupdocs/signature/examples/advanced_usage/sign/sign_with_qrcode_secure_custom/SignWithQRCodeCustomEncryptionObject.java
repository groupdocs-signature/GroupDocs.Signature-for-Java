...
public class SignWithQRCodeCustomEncryptionObject {
    ...
    */
    ...
    {
        System.out.print("\n--------------------------------------------------------------------------------------------------------------------");
        System.out.print("[Example Advanced Usage] # SignWithQRCodeCustomEncryptionObject : Sign document with QR-Code signature applying specific options.\n");

        // The path to the documents directory.
        String filePath = Constants.SAMPLE_PDF;

        String outputFilePath = new File(Constants.OutputPath, "SignWithQRCodeSecureCustom//QRCodeCustomEncryptionObject.pdf").getPath();
