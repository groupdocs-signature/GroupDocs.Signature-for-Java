...
public class SearchForImageAdvanced {
    ...
    public static void run()
    {
        ...
        try /*JAVA: was using*/
        {
            PagesSetup tmp0 = new  PagesSetup();
            tmp0.setFirstPage(true);
            tmp0.setLastPage(true);
            tmp0.setOddPages(false);
            tmp0.setEvenPages(false);
            // setup search options
            ImageSearchOptions searchOptions = new ImageSearchOptions();
            searchOptions.setAllPages(false);
            searchOptions.setPageNumber(1);
            searchOptions.setPagesSetup(tmp0);
