...
public class SignZIPArchiveDocuments
{
    ...
    {
        System.out.print("\n--------------------------------------------------------------------------------------------------------------------");
        System.out.print("[Example Advanced Usage] # SignZIPArchiveDocuments : Sign ZIP archive document with various signature options\n");

        // The path to the documents directory.
        String filePath = Constants.SAMPLE_ZIP;
        String fileName = Paths.get(filePath).getFileName().toString();
        String outputFilePath = new File(Constants.OutputPath, "SignZIPArchiveDocuments//" + fileName).getPath();
