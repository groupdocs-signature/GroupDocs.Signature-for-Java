...
public class SignWithMetadataCustomSerializationObject {
    ...
    */
    ...
    {
        System.out.print("\n--------------------------------------------------------------------------------------------------------------------");
        System.out.print("[Example Advanced Usage] # SignWithMetadataCustomSerializationObject : Sign pdf document with metadata signature with customer object and encryption.\n");
