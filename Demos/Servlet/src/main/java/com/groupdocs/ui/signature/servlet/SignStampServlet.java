...
@WebServlet("/signature/signStamp")
public class SignStampServlet extends CORSServlet {
    private static final Logger logger = LoggerFactory.getLogger(SignStampServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SignedDocumentEntity signedDocumentEntity = signatureService.signStamp(signDocumentRequest);
