...
@WebServlet("/signature/signDigital")
public class SignDigitalServlet extends CORSServlet {
    private static final Logger logger = LoggerFactory.getLogger(SignDigitalServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SignedDocumentEntity signedDocumentEntity = signatureService.signDigital(signDocumentRequest);
