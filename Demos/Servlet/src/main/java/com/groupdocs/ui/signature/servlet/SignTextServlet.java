...
@WebServlet("/signature/signText")
public class SignTextServlet extends CORSServlet {
    private static final Logger logger = LoggerFactory.getLogger(SignTextServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SignedDocumentEntity signedDocumentEntity = signatureService.signText(signDocumentRequest);
