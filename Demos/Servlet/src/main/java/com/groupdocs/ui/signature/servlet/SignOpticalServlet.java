...
@WebServlet("/signature/signOptical")
public class SignOpticalServlet extends CORSServlet {
    private static final Logger logger = LoggerFactory.getLogger(SignOpticalServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        SignedDocumentEntity signedDocumentEntity = signatureService.signOptical(signDocumentRequest);
