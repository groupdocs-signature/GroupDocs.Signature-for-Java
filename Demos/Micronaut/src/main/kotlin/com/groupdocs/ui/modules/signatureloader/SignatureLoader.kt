 ...
 */
{
    ...
    companion object {
        ...
        fun loadImageSignatures(currentPath: String, dataPath: String): List<SignatureFileDescriptionEntity> {
            val directory = File(currentPath)
            val fileList = ArrayList<SignatureFileDescriptionEntity>()
                ...
                if (filesList != null) {
                    for (file in filesList) {
                        ...
                        if (!file.isDirectory && checkFile(dataPath, file)) {
                            val fileDescription: SignatureFileDescriptionEntity = getSignatureFileDescriptionEntity(file, true)
        ...
        private fun getSignatureFileDescriptionEntity(file: File, withImage: Boolean): SignatureFileDescriptionEntity {
            ...
            return SignatureFileDescriptionEntity(
                guid = URLEncoder.encode(file.absolutePath, StandardCharsets.UTF_8.toString()),
                name = file.name,
