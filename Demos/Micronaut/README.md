...
# GroupDocs.Signature Micronaut Example
...
Download [source code](https://github.com/groupdocs-signature/GroupDocs.Signature-for-Java/releases/download/v23.6/groupdocs-signature-micronaut-23.6.0.zip) from github or clone this repository.


```bash
git clone https://github.com/groupdocs-signature/GroupDocs.Signature-for-Java.git
cd GroupDocs.Signature-for-Java/Demos/Micronaut
```
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-signature/GroupDocs.Signature-for-Java/releases/download/v23.6/groupdocs-signature-micronaut-23.6.0.tar
tar -xvzf release.tar.gz
cd release/signature-micronaut-23.6
## Make `bin/signature-micronaut` file to be runnable
bin/signature-micronaut
