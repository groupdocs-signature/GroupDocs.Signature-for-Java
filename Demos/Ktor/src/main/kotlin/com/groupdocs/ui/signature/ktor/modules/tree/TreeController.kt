package com.groupdocs.ui.signature.ktor.modules.tree
...
import com.groupdocs.ui.signature.ktor.model.TreeRequest
import com.groupdocs.ui.signature.ktor.modules.BaseController
import com.groupdocs.ui.signature.ktor.usecase.GetLocalFilesUseCase
import com.groupdocs.ui.signature.ktor.usecase.LocalStorageEntry
...
class TreeControllerImpl(
     ...
     */
    private fun loadFiles(signatureType: String, relDirPath: String): List<FileDescriptionEntity> {
        var fileList: List<FileDescriptionEntity>
